const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reduxStore-CicqAysr.js","assets/index-DCZ1n_pS.js","assets/index--c1wzNd1.css","assets/llm-HA9HYYRG.js","assets/oauth-yImE6aai.js","assets/durability-BMrK4bko.js","assets/slackSocketMode-EU9qzHYl.js","assets/api-CqL7sijx.js","assets/reduxStore-D48H3HFA.css","assets/faultExport-m7UovKTZ.js","assets/Assistant-BPUO3HP5.js","assets/ReduxAppDataRoot-48IqavNN.js","assets/cronStream-BA7vHZ6W.js","assets/canonicalProjectPatchSet-BLmDd0Rk.js","assets/openrouter-BUUBiE5I.js","assets/pkce-CpKKDV7R.js","assets/oauth-DfakV9nM.js","assets/App-DcEGBLhb.js","assets/isObject-CGZ9pm3u.js","assets/toNumber-DbsqjrQD.js","assets/Assistant-Dae88zj3.css"])))=>i.map(i=>d[i]);
import{r as K,j as B,c as tn,w as ut,s as Oc,_ as Io,d as Xi,g as Fc,R as Bc,e as zc,f as kc}from"./index-DCZ1n_pS.js";import{cb as Dl,cc as Vc,cd as Il,ce as Hc,cf as Gc,cg as Wc,ch as Xc,ci as qc,cj as vi,ck as jc,cl as $c,cm as Ul,cn as Yc,co as da,cp as Kc,cq as Ln,cr as Ki,cs as Zi,ct as Zc,aB as Jc,x as Ns,cu as Qc,j as eu,cv as tu,cw as Nl,cx as nu,bW as ha,cy as iu,cz as ru,cA as su,cB as ou,cC as au,cD as lu,cE as cu,cF as fa,cG as uu,cH as du,T as cr,cI as pa,cJ as hu,E as ma}from"./reduxStore-CicqAysr.js";import{d as qn,R as fu,a as pu}from"./ReduxAppDataRoot-48IqavNN.js";import{i as Ji,m as Uo,o as mu,p as Ol}from"./llm-HA9HYYRG.js";import{m as gu,n as vu,o as _u,c as xu,q as Su,t as Mu,S as Fl}from"./durability-BMrK4bko.js";const Bl=K.createContext(null);function No(){return K.useContext(Bl)}const yu=typeof Symbol=="function"&&Symbol.for,Eu=yu?Symbol.for("mui.nested"):"__THEME_NESTED__";function Tu(n,e){return typeof e=="function"?e(n):{...n,...e}}function bu(n){const{children:e,theme:t}=n,i=No(),r=K.useMemo(()=>{const s=i===null?{...t}:Tu(i,t);return s!=null&&(s[Eu]=i!==null),s},[t,i]);return B.jsx(Bl.Provider,{value:r,children:e})}function wu(n){const e=Dl(),t=Vc()||"",{modularCssLayers:i}=n;let r="mui.global, mui.components, mui.theme, mui.custom, mui.sx";return!i||e!==null?r="":typeof i=="string"?r=i.replace(/mui(?!\.)/g,r):r=`@layer ${r};`,Il(()=>{const s=document.querySelector("head");if(!s)return;const o=s.firstChild;if(r){if(o&&o.hasAttribute?.("data-mui-layer-order")&&o.getAttribute("data-mui-layer-order")===t)return;const a=document.createElement("style");a.setAttribute("data-mui-layer-order",t),a.textContent=r,s.prepend(a)}else s.querySelector(`style[data-mui-layer-order="${t}"]`)?.remove()},[r,t]),r?B.jsx(Hc,{styles:r}):null}const ga={};function va(n,e,t,i=!1){return K.useMemo(()=>{const r=n&&e[n]||e;if(typeof t=="function"){const s=t(r),o=n?{...e,[n]:s}:s;return i?()=>o:o}return n?{...e,[n]:t}:{...e,...t}},[n,e,t,i])}function zl(n){const{children:e,theme:t,themeId:i}=n,r=Dl(ga),s=No()||ga,o=va(i,r,t),a=va(i,s,t,!0),c=(i?o[i]:o).direction==="rtl",l=wu(o);return B.jsx(bu,{theme:a,children:B.jsx(Gc.Provider,{value:o,children:B.jsx(Wc,{value:c,children:B.jsxs(Xc,{value:i?o[i].components:o.components,children:[l,e]})})})})}const Oo="mode",Fo="color-scheme",Au="data-color-scheme";function Ru(n){const{defaultMode:e="system",defaultLightColorScheme:t="light",defaultDarkColorScheme:i="dark",modeStorageKey:r=Oo,colorSchemeStorageKey:s=Fo,attribute:o=Au,colorSchemeNode:a="document.documentElement",nonce:c}=n||{};let l="",d=o;if(o==="class"&&(d=".%s"),o==="data"&&(d="[data-%s]"),d.startsWith(".")){const f=d.substring(1);l+=`${a}.classList.remove('${f}'.replace('%s', light), '${f}'.replace('%s', dark));
