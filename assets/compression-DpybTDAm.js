import{g as C,a as x,i as N,b as k}from"./AssistantApp-BY3COFCb.js";import"./index-Cpthn_KO.js";import"./chunk-B3F52NIX-CxsVodFh.js";function R(a){return a.role!=="function"&&"content"in a}function T(a){return a.trim().startsWith("<file")}function A(a){const u=[],g=new Map;let d=0,f=0,n=0;return a.forEach((r,l)=>{if(r.role==="system"||r.role==="developer"||r.role==="function"||!R(r))return;let t;if(r.role==="user")d++,t=`U${d}`;else if(r.role==="assistant")f++,t=`R${f}`;else if(r.role==="tool")n++,t=`T${n}`;else return;if(typeof r.content=="string"){const s=r.content.split(`
`);u.push(`
